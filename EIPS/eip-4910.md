...
description: Extension of EIP-721 NFTs to correctly define, process, and pay (hierarchical) on-chain royalties from NFT sales.
...
## Abstract
This proposal directly connects NFTs and royalties in a smart contract architecture extending the [EIP-721](./eip-721.md) standard, with the aim of precluding central authorities from manipulating or circumventing payments to those who are legally entitled to them.
...
* **Token Type**
    * Token Type is given as either ETH or the symbol of the supported [EIP-20](./eip-20.md), or [EIP-777](./eip-777.md) tokens such as `DAI`
* **Asset ID**
